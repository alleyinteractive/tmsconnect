...
function tmsc_helper_image_mediaview() {
	return '';
}

function tmsc_helper_type() {
	// Takes in post ID and returns term objects in taxonomy classifcation.
	return '<a href="#">Manuscript</a>';
}

function tmsc_helper_maker() {
	// Takes in post ID and returns term objects in taxonomy constituent.
	return '<strong>Calligrapher:</strong> <a href="#">Ahmad Sayri</a>';
}

function tmsc_helper_time_period() {
	// Takes in post ID and returns term objects in taxonomy period.
...
function tmsc_helper_georgraphy() {
	return '<a href="#">Iran</a>';
}

function tmsc_helper_notes() {
	return '';
}

function tmsc_helper_creditline() {
	return 'Purchase &mdash; Charles Lang Freer Endowment';
}

function tmsc_helper_collection() {
...
function tmsc_helper_jades_captions() {
	return '';
}
...
function tmsc_helper_classifications() {
	return '<a href="#">Manuscript</a>';
}

function tmsc_helper_keywords() {
...
function tmsc_helper_constituent() {
	// Takes in post ID and returns term objects in taxonomy constituent.
	return '<a href="#">Hagop Kevorkian (1872 - 1962)</a>';
}

function tmsc_helper_description() {
...
function tmsc_helper_inscriptions() {
...
function tmsc_helper_signatures() {
	return '';
}

function tmsc_helper_markings() {
	return '';
}

function tmsc_helper_label() {
	return '';
}

function tmsc_helper_past_label() {
...
function tmsc_helper_jades_curatorial_remarks() {
	return '';
}

function tmsc_helper_unpublished_research() {
	return '';
}

function tmsc_helper_bibliography() {
	return '';
}

function tmsc_helper_rightsstatement() {
 ...
 * false = LTR
 */
function tmsc_helper_slideshow_rtl() {
	return true;
}
 ...
 */
function tmsc_helper_initial_slide() {
	return 0;
}
 ...
 */
function tmsc_helper_rights_type() {
	return true;
}
...
function tmsc_helper_media_type() {
	return 'Image';
}

function tmsc_helper_media_view() {
	return 'group view';
}
 ...
 * In single-tmsc_object.php, it's looped through to recreate the original markup from the Object-Template example
 *
 * To emulate the Object-Template example, some images have a 'data-media-master-id' value
 */
function tmsc_helper_images() {
	$tmsc_images = array(
		0 => array(
